    ...
    return (
        <Layout>
            ...
            <div className="mainSection">
                ...
                <p>I am a strong believer in (our) <b>data privacy</b> so you'll often see me rant about it if you follow me on <a href="https://twitter.com/@flopreynat" target="_blank">twitter</a>, or if you read my <Link to="/blog">blog</Link>.</p>
